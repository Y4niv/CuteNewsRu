...
[if-logged]<small style="font-size: 10px;"> (<a href="{cutepath}/index.php?mod=editcomments&amp;newsid={id}&amp;comid={comment-id}" target="_blank" title="Edit comment" style="color: #ccc;">Edit</a> / <a href="{cutepath}/index.php?mod=editcomments&amp;action=dodeletecomment&amp;newsid={id}&amp;delcomid[]={comment-id}&amp;deletecomment=yes" target="_blank" title="Delete comment" style="color: #ccc;">Delete</a>)</small>[/if-logged]
<br />
<br />
{comment}
</div>
